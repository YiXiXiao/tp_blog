...
class Page extends Think {
    ...
    protected $rollPage   ;
	// 分页显示定制
    protected $config  =	array('header'=>'篇博文','prev'=>'上一页','next'=>'下一页','first'=>'第一页','last'=>'最后一页','theme'=>'共有 %totalRow% %header% 当前第%nowPage%/%totalPage% 页 %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                ...
                if($this->totalPages != 1){
                    $linkPage .= "&nbsp;<a class='current' href='".$url."&".$p."=$page'>&nbsp;".$page."&nbsp;</a>";
                }
            }
        }
        $pageStr	 =	 str_replace(
